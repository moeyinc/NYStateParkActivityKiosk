...
var db;
MongoClient.connect("mongodb://localhost:27017/Hallock_activity_kiosk", {native_parser:true}, function(err, _db) {
...
var storage = multer.diskStorage({
  ...
  filename: function (req, file, cb) {
    ...
    console.log('destination: ',  path.resolve('../public/static/imgs/'))
