<!--
customizing npm package 'vue2-scrollbar'
...
<template>
  <div>
    <div
      ...
      <div
        :class="'scrollbar' + ( dragging || draggingFromParent ?
        ...
        :style="[{
          ...
          $store.state.generalSettings.text_color)}]">
      </div>
  ...
  methods: {
    ...
    jump(e) {
      ...
      if (isContainer) {
        ...
        let yMovementPercentage =
          yMovement / this.wrapper.height * 100 - centerize;
